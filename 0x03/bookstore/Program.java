public class Program {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.printf("Title: %s - Author: %s - Price: %.2f\n",
                    goldEditionBook1.getTitle(), goldEditionBook1.getAuthor(), goldEditionBook1.getPrice());
        } catch (Exception ex) {
            System.out.println(ex.getMessage() + "\n");
        }
        ...
        try {
            ...
            System.out.printf("Title: %s - Author: %s - Price: %.2f\n",
                    goldEditionBook2.getTitle(), goldEditionBook2.getAuthor(), goldEditionBook2.getPrice());
        } catch (Exception ex) {
            System.out.println(ex.getMessage() + "\n");
        }
